...
public class LogBookService {
  ...
  @Transactional
  public List<LogBookResponse> getLogBooksByMonitorId(Long monitorId) {
    List<LogBook> logbooks = logBookRepository.findByMonitorIdOrderByStartTimeDesc(monitorId);
    return logBookMapper.toResponseList(logbooks);
  }

  @Transactional
  public List<LogBookResponse> getAllLogBooks() {
    List<LogBook> logbooks = logBookRepository.findAllByOrderByStartTimeDesc();
    return logBookMapper.toResponseList(logbooks);
  }
